...
(function( $ ) {
	...
	var CONFIG = (function() {
		...
		var internal = {
				...
				'MANDATORY_FIELDS'	: [
				                  	   /* Ids */
				                  	   ['applicationNumber', 'jurisdiction', 'mailingDate','documentDescription' , 'uploadFile'],
				                  	    /* MessageKeys */
				                  	    ['correspondenceForm.applicationNumber', 'correspondenceForm.jurisdiction', 'correspondenceForm.mailingDate','correspondenceForm.documentDescription', 'correspondenceForm.file']
				                  	   ],
	 ...
	 */
	$.blackbox.validator.NewCorrespondenceFormValidator = function() {
	};
	
	$.blackbox.validator.NewCorrespondenceFormValidator.validate = function() {
		var constant = $.blackbox.Constant;
