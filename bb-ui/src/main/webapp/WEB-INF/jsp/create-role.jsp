...
<form:form id="roleForm" commandName="roleForm" method="post" action="submit">
	...
	<div class="main-content container">
		<div class="row">
			<div class="col-sm-12">
				<div class="page-header">
					...
					<h2 class="page-heading"><spring:message code="role.page.create.new" /></h2>
				</div>
			</div>
		</div>
		<!--create new role-->
		<div class="panel-group user-management" id="accordion" role="tablist" aria-multiselectable="true">
			    ...
			    <div class="panel-heading" role="tab" id="defineRole">
			      <h4 class="panel-title">
			        ...
			        <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
			          <spring:message code="role.page.define.role" /><span class="asterisk">&nbsp;&nbsp;*</span><span class="selected"></span><span class="icon icon-arrow-down"></span><span class="icon icon-arrow-up"></span>
			        </a>
			      </h4>
			    </div>
			...
			<div class="panel panel-default">  
				<div class="panel-heading" role="tab" id="accessProfile">
			      <h4 class="panel-title">
			        <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
			          <spring:message code="role.page.access.profile" /> <span class="asterisk">*</span> <span class="selected"></span><span class="icon icon-arrow-down"></span><span class="icon icon-arrow-up"></span>
			        </a>
			      </h4>
			    </div>
			    <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="accessProfile">
			      <div class="panel-body">
			      	<div class="form-horizontal">
			        	<div class="form-group">
			        		<div class="col-sm-12">
			        			<div class="col-sm-6 pad-left0">
									...
									<div class="col-sm-6">
										<form:select path="accessProfileId" id="selectProfile" class="form-control" onchange="loadAccessProfile();">
											<form:option id="SELECT" value="0">Select</form:option>
			      	...
			      	<c:choose>
				      	<c:when test="${empty roleForm.dataAccessErrors}">
							...
							<a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
					          <spring:message code="role.page.data.access" />&nbsp;&nbsp;<span class="asterisk">*</span> <span class="selected"></span><span class="icon icon-arrow-down"></span><span class="icon icon-arrow-up"></span>
					        </a>
						</c:when>
				        <c:otherwise>
		...
		<div class="form-horizontal form-footer">
			<div class="col-sm-12">
				...
				<div class="form-group  text-left">
					<form:button type="button" class="btn btn-cancel" onclick="popupMsgForCancelSaveRole(this);"><spring:message code="button.cancel" /></form:button>
					...
					<form:button id="createRole" value="submit" class="btn btn-submit"><spring:message code="role.page.create" /></form:button>
				</div>
			</div>
		</div>
	</div>
