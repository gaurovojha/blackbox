...
<div class="modal-dialog" role="document">
	<div class="modal-content">
		<div class="modal-header">
			...
			<h4 class="modal-title" id="myModalLabel">Abandon Record</h4>
		</div>
		<div class="modal-body">
			<form:form class="form-horizontal" method="get"
				modelAttribute="mdmRecordStatus"
				action="${contextPath}/mdm/application/abandon/recordStatus">
				...
				<div class="form-group">
					<div class="col-sm-12">
						<input type="checkbox" name="familyMembers" id="familyMembers" /><label class="control-label"
	  ...
	  <div id="abandonConfirmationBox" class="abandonConfirmationBox popup-msg">
		...
		<div class="modal-footer">
		    ...
		    <div class="modal-footer">
					...
					<button type="button" class="btn btn-submit" onclick="showConfirmationBox();">Allowed to Abandon</button>
			</div>
		</div>
	</div>
</div>
...
<script>
	function showConfirmationBox() {
		$('.abandonConfirmationBox').find('.msg ').text(
				'Are you sure want to abandon this record ?');
		$('.abandonConfirmationBox').show();
		$('.abandonConfirmationBox').wrap("<div class='overlay'>");
	}

	function hideConfirmationBox() {
		$('.abandonConfirmationBox').hide();
		$('.abandonConfirmationBox').unwrap("<div class='overlay'>");
	}
</script>
