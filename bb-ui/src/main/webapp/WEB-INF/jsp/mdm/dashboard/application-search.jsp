					...
					<div class="col-sm-12">
						<div class="col-sm-6">
							<label class="control-label">Application Number</label> <input
								type="text" id="txtApplicationNo" class="form-control searchVariable">

						</div>
						<div class="col-sm-6">
							<label class="control-label">Jurisdiction</label> <input
								type="text" id="txtJurisdiction" class="form-control searchVariable">
						</div>
					</div>
				</div>
			</form>
					...
					<div class="col-sm-12">
						<div class="col-sm-6">
							<label class="control-label">Attorney Docket Number</label> <input
								type="text"  id="txtAttorneyDocketNo" class="form-control searchVariable">
						</div>
					</div>
				</div>
			</form>
					...
					<div class="col-sm-12">
						<div class="col-sm-6">
							<label class="control-label">Family ID</label> <input type="text" id="txtFamilyId"
								class="form-control searchVariable">
						</div>
					</div>
				</div>
			</form>
					...
					<div class="col-sm-12">
						<div class="col-sm-6">
							...
							<div class="daterange-picker">
								<input type="text" class="form-control date searchVariable" name="datefilterSearch" id="txtUploadedOn"> <span
						...
						<div class="col-sm-6">
							<label class="control-label">Document Description</label> <input
								type="text" id = "txtDescription"class="form-control searchVariable">
						</div>
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-12">
						<div class="col-sm-6">
							<label class="control-label">Uploaded By</label> <input
								type="text" id="txtUploadedBy" class="form-control searchVariable">
						</div>
					</div>
				</div>
			</div>
