	...
	<div class="col-sm-8 left-col">
		<div class="form-horizontal">
			<div class="form-group">
				<div class="col-sm-12">
					<div class="panel-group user-management" id="accordionDel"
						role="tablist" aria-multiselectable="true">
						<div class="panel panel-default">
							<div class="panel-heading" role="tab">
								<h4 class="panel-title">
									<span></span> <a role="button" class="collapse"
										data-toggle="collapse" data-parent="#accordionDel"
										href="#collapseThreeDel" aria-expanded="false"
							...
							<div id="collapseThreeDel" class="panel-collapse in" role="tabpanel"
								aria-labelledby="defineRole" aria-expanded="false">
								<div class="panel-body">
									<table class="table custom-table mTop10 clickable" id="deletedPatentTable">
										<thead>
											<tr>
												<th>
						...
						<div class="panel panel-default">
							<div class="panel-heading" role="tab">
								<h4 class="panel-title">
									<a class="collapsed" role="button" data-toggle="collapse"
										data-parent="#accordionDel" href="#collapseFourDel"
							...
							<div id="collapseFourDel" class="panel-collapse collapse"
								role="tabpanel" aria-expanded="false">
								<div class="panel-body">
									<table class="table custom-table mTop10 clickable" id="deletedNplTable">
										<thead>
											<tr>
												<th>
													<div class="checkbox-without-label">
