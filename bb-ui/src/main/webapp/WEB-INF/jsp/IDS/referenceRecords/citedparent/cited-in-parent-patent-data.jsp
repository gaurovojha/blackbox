...
<input type="hidden" id="recordsTotal" value="${patentListCitedInParent.totalElements}" />
<input type="hidden" id="recordsFiltered" value="${patentListCitedInParent.totalElements}"/>

<p id="splitter"/>

<c:forEach items="${patentListCitedInParent.content}" var="patentData" varStatus="status">
	<tr>
		<td>
