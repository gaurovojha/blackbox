...
<input type="hidden" id="recordsTotal" value="${patentListExaminerCited.totalElements}" />
<input type="hidden" id="recordsFiltered" value="${patentListExaminerCited.totalElements}"/>

<p id="splitter"/>

<c:forEach items="${patentListExaminerCited.content}" var="patentData" varStatus="status">
	<tr>
		<td>
