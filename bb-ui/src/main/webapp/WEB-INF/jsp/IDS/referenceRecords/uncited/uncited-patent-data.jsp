...
<input type="hidden" id="recordsTotal" value="${patentListUnCited.totalElements}" />
<input type="hidden" id="recordsFiltered" value="${patentListUnCited.totalElements}"/>

<p id="splitter"/>

<c:forEach items="${patentListUnCited.content}" var="patentData" varStatus="status">
	<tr>
		<td>
