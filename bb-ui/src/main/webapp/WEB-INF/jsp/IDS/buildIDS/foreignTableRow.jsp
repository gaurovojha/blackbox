			...
			<td>
				<div class="action-btns-grid">
					<a href="javascript:void(0)"><i><img
							src="${contextPath}/assets/images/svg/review-doc.svg"
							class="icon16x"></i> Review</a>
					<div class="dropdown grid-dropdown">
						<a id="drop4" href="#" class="dropdown-toggle"
							data-toggle="dropdown" role="button" aria-haspopup="true"
							aria-expanded="false"><img
							src="${contextPath}/assets/images/svg/drop.svg" class="icon20x">
							<span class="action-danger">Drop</span> <span class="caret"></span>
						</a>
						<ul id="menu1" class="dropdown-menu" aria-labelledby="drop4">
							<li><a class="drop-all" data-RefID="${item.refFlowId}"
								href="#" data-toggle="modal" data-target="#dropRefAllIdsPopUp">Do
									Not File</a></li>
							<li><a class="drop-all" data-RefID="${item.refFlowId}"
								href="#" data-toggle="modal"
								data-target="#dropRefFromThisIdsPopUp">Drop from this IDS</a></li>
						</ul>
					</div>
				</div>
			</td>
