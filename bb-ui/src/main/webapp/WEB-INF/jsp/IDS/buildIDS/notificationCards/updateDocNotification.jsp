...
<div class="notification-box">
	...
	<div class="form-horizontal clearfix">
		...
		<div class="col-sm-2">
			<label class="control-label"><spring:message
					code="ids.initiateIDS.idsNotification.status" /></label>
			<div class="form-control-static">
				<span class="action-faulty"><i><img
						src="${pathImg}/exclamation.svg" class="icon16x"></i>
					Application #, mismatch</span>
			</div>
		</div>
	</div>
	<div class="footer">
		<button class="btn btn-submit" type="button">
			<spring:message code="button.reviewdocument" />
		</button>
