...
<div class="notification-box">
	...
	<div class="form-horizontal clearfix">
		...
		<div class="col-sm-2">
			<label class="control-label"><spring:message
					code="ids.initiateIDS.idsNotification.mailingdateonorafter" /></label>
			<div class="form-control-static">${notification.mailingDate}</div>
		</div>
		<div class="col-sm-2">
			<label class="control-label"><spring:message
					code="ids.initiateIDS.idsNotification.docdescription" /></label>
			<div class="form-control-static">
				${notification.documentDescription} <a href="#"><i><img
						src=${pathImg}/attachment.svg " class="icon16x"></i></a>
			</div>
		</div>
	</div>
	<div class="footer">
		<button class="btn btn-submit" type="button"><spring:message code="button.reject" /></button>
		<button class="btn btn-submit" type="button"><spring:message code="button.uploaddocument" /></button>
