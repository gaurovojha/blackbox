...
<div class="notification-box">
	...
	<div class="clearfix">
		<h4><spring:message code="ids.initiateIDS.idsNotification.updateapplicationrecord" /></h4>
	</div>
	<div class="form-horizontal clearfix">
		...
		<div class="col-sm-2">
			<label class="control-label"><spring:message
						code="ids.initiateIDS.idsNotification.referencedocument" /></label>
			<div class="form-control-static">
				Non-final Rejection <a href="#"><i><img
						src="${pathImg}/attachment.svg" class="icon16x"></i></a>
			</div>
		</div>
		<div class="col-sm-4">
			<label class="control-label"><spring:message
						code="ids.initiateIDS.idsNotification.identifieddiscrepancies" /></label>
			<div class="form-control-static">
				<span class="action-faulty"><i><img
						src="${pathImg}/exclamation.svg" class="icon16x"></i> Customer
					#, Title</span>
			</div>
		</div>
	</div>
	<div class="footer">
		<button class="btn btn-submit" type="button"><spring:message code="button.edit"/> </button>
