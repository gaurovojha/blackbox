...
<div id="usUnpublishApplication">
	 <div class="form-group USCheck">
	    <div class="col-sm-6">
	        ...
	        <div class="input-group date datepicker">
	            <form:input class="form-control" id="nplPublicationDate" path="publicationDateStr"></form:input>
   ...
   <div class="col-sm-6 text-left">
      <div class="form-control-static">
         <a href="javascript:document.getElementById('PdfFileNPL').click()"><i><img src="<%=images %>/svg/add.svg" class="icon16x"></i>
         <form:input path="file" id="PdfFileNPL" class="form-element" type="file" style="display:none" accept="application/pdf" /><label for="PdfFileNPL">Add an Attachment (PDF Only)</label></a><div id="filenameNPL"></div> 
      </div>
   </div>
