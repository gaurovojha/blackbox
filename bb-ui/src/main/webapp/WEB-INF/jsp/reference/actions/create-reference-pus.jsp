...
<div id="InMannualUS">
    <div class="form-group" id="usDataMyself">
      <div class="col-sm-6">
      	<c:choose>
      		<c:when test="${not empty referenceDTO.correspondenceId.id}">
         ...
         <form:label class="control-label" path="applicantName">Patentee / Applicant Name  <span class="required">*</span></form:label>
         <form:input class="form-control form-element" id="usApplicantName" path="applicantName" />
