			...
			<tr class="odd">
				...
				<td>
					<div class="action-btns-grid">
						<form method="post" action="createSelfCitedReference" id="form${application.applicationNumber}">
							...
							<a href="javascript:void(0)" onclick="document.getElementById('form${application.applicationNumber}').submit();">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Select</a>
						</form>
					</div>
				</td>
