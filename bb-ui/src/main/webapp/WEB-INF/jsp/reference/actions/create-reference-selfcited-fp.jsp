...
%>
   ...
   <div class="form-group">
      <div class="col-sm-2">
         ...
         <form:input type="text" class="form-control form-element jurisdiction" id="fgnJurisdictioin" path="jurisdiction.name" />
      ...
      <div class="col-sm-7">
        ...
        <div class="col-sm-5">
         ...
         <div class="input-group date datepicker">
            <form:input class="form-control" id="fgnPublicationDate" path="publicationDateStr"/>
...
<div class="form-group">
   ...
   <div class="col-sm-6 text-right">
      <input type="checkbox" id="engTranslation">
      <label class="control-label form-element" for="engTranslation">English Translation</label>
   </div>
</div>
