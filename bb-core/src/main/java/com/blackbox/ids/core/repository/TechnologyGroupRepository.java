...
/**
 * A DAO for the entity TechnologyGroup is simply created by extending the JpaRepository
 ...
 * @author Nagarro
 */
@Repository("technologyGroupRepository")
public interface TechnologyGroupRepository extends JpaRepository<TechnologyGroup, Long> {
}
